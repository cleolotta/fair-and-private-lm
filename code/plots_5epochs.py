...
def plot_linear(xlabel,ylabel,title,var,data_mia_aug,data_mia_full,data_mia_dp,f_name):
    ...
    ax3.legend(title='Fine-tuning Method',labels=['FT with augmented data','FT with not-augmented data', 'FT with DP'])
...
data_mia_full_augmented = get_data_mia("C:/Users/cmatz/master-thesis/fair-and-private-lm/debiasing/ft_gpt2-medium_mia_aug_trained_5epochs/stdout",hue='Debiased model')
data_mia_full_original =  get_data_mia("C:/Users/cmatz/master-thesis/fair-and-private-lm/debiasing/ft_gpt2-medium_og_trained_5epochs/stdout", hue = 'Not debiased model')
data_lora_dp = get_data_mia("C:/Users/cmatz/master-thesis/fair-and-private-lm/debiasing/ft_gpt2-medium_dp_5epochs/stdout", hue = 'DP model')
...
df_all= pd.concat([df_augmented, df_original, df_dp], axis=0)
...
plot_linear(xlabel,ylabel,title,var,df_augmented,df_original, df_dp,f_name)
