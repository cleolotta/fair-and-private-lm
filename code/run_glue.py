...
import sys
sys.path.append("/storage/ukp/work/matzken/fplm/ft_gpt2/experiments/bias-bench-main")
...
def main():
    ...
    lora_models = ["DPLoRAGPT2ForSequenceClassification", "LoRAGPT2ForSequenceClassification", "LoRAptGPT2ForSequenceClassification"]
    if model_args.model in lora_models:
        print("load lora model")
        model = getattr(models, model_args.model)(
            model_args.model_name_or_path, config,  model_args.lora_dim, model_args.lora_alpha, model_args.lora_dropout, **kwargs
        )
