...
if __name__ == '__main__':
    ...
    f.close()
    f1 = open(args.output_file2, "w+") #original 
    f1.close()
    # open the output text file to append sentence by sentence
    with open(args.output_file,'a+', encoding='utf-8') as f, open(args.output_file2, 'a+', encoding="utf-8") as f1:
        ...
        for block in dataset_wikipedia["train"]:
            ...
            for i in range(len(s_list)): # for each single sentence
                ...
                if edit:
                    ...
                    sent_count_aug += 1
        print("...done\n\n")
        print(f"final og: {sent_count_og}")
        print(f"final aug {sent_count_aug}")

## python CDA_wikipedia_bookcorpus.py --output_file "./original_data_mlm/augmented-data-big2.txt" --output_file2 "./original_data_mlm/original-data-big2.txt" --skip_sentences 50 --block_size 100 