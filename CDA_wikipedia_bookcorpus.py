...
def get_gender_word_pairs():
    ...
    file_wordlist = open('./datasets/wordpairs/cda_word_pairs_gender.txt', 'r', encoding="utf-8") 
    ...
    file_wordlist = open('./datasets/wordpairs/cda_word_pairs_gender_extra.txt', 'r', encoding="utf-8") 
    lines_wordlist = file_wordlist.readlines()
    for line in lines_wordlist:
        word_pair = line.split()
    ...
    file_wordlist = open('./datasets/wordpairs/cda_word_pairs_names.txt', 'r', encoding="utf-8") 
    lines_wordlist = file_wordlist.readlines()
    for line in lines_wordlist:
        word_pair = line.split()
        if not is_pair_in_list(word_pairs, word_pair):
